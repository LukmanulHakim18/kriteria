...
$menuItems = [
    ...
    ['label' => 'Data Master', 'url' => ['/site/index'], 'options' => ['class' => 'kt-menu__section']],
     ['label' => 'Beranda', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
</svg>', 'url' => ['/fakultas/default/index','fakultas'=>$_GET['fakultas']]],
    ['label' => 'Berkas Fakultas', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect id="bound" x="0" y="0" width="24" height="24"/>
...
</svg>', 'url' => ['/fakultas/berkas/index','fakultas'=>$_GET['fakultas']]],
