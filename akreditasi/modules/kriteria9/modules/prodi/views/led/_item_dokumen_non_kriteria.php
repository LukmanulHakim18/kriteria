...
<table class="table table-striped table-hover">
            ...
            <td>
                <div class="row pull-right">
                    <div class="col-lg-12">
                        ...
                        <?php $form = ActiveForm::begin(['action' => \yii\helpers\Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $dokAttr . "-text-$jenis-form"]) ?>
                        ...
                        <?php $form = ActiveForm::begin(['action' => \yii\helpers\Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $dokAttr . "-link-$jenis-form"]) ?>
                        ...
                        <?php $form = ActiveForm::begin(['action' => \yii\helpers\Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $dokAttr . "-upload-$jenis-form"]) ?>

                        <?= $form->field($uploadModel, 'kode_dokumen')->textInput(['value' => $dok->kode, 'readonly' => true]) ?>
                        <?= $form->field($uploadModel, 'nama_dokumen')->textInput(['value' => $dok->dokumen, 'readonly' => true]) ?>
                        <?= $form->field($uploadModel, 'jenis_dokumen')->textInput(['value' => $jenis, 'readonly' => true]) ?>
    ...
    $detail = $detailCollection->where('jenis_dokumen',$jenis)->where('kode_dokumen',$dok->kode)->values()->all();
