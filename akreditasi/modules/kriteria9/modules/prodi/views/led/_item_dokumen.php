            ...
            <td>
                <div class="row pull-right">
                    <div class="col-lg-12">
                        ...
                        <?= $form->field($detailModel, 'jenis_dokumen')->textInput(['value' => $jenis, 'readonly' => true]) ?>
                        ...
                        <?php Modal::end() ?>
                        <?=Html::submitButton('<i class="flaticon2-laptop"></i> Gunakan Data',['value'=>\yii\helpers\Url::to(['resource/index','prodi'=>$_GET['prodi'],'kriteria'=>$kriteria,'kode'=>$dok->kode,'jenis'=>Constants::LED,'id_led_lk'=>$_GET['led'],'jenis_dokumen'=>$jenis]),'title'=>'Gunakan Data Untuk : '.$dok->kode.'.'.' '.$dok->dokumen ,'class'=>'btn btn-warning btn-pill btn-elevate btn-elevate-air showModalButton'])?>
                    </div>
                </div>
