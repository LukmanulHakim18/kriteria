...
$this->params['breadcrumbs'][] = ['label' => 'Led', 'url' => ['/kriteria9/k9-prodi/led/arsip', 'target' => 'lihat','prodi'=>$prodi]];
                ...
                <?php foreach ($json as $kriteriaJson): ?>
                    <tr>
                        ...
                        <td style="padding-top: 15px;">
                            <?= Html::a("<i class='la la-folder-open'></i>Lihat", ['led/lihat-kriteria', 'led' => $_GET['led'], 'kriteria' => $kriteriaJson['kriteria'],'prodi'=>$prodi], ['class' => 'btn btn-default btn-pill btn-elevate btn-elevate-air']) ?>
