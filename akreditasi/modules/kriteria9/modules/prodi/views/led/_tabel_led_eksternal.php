    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="padding-top: 15px;">
                <?= Html::a("<i class='la la-folder-open'></i>Lihat", ['led/'.$untuk.'-kriteria', 'led' => $_GET['led'], 'kriteria' => $json_eksternal->nomor,'prodi'=>$prodi], ['class' => 'btn btn-default btn-pill btn-elevate btn-elevate-air']) ?>
