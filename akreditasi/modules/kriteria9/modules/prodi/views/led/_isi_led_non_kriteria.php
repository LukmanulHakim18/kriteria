...
<div class="led-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php
            if ($untuk === 'isi'):
                $form = ActiveForm::begin(['action' => Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $modelAttribute . '-form']) ?>
            ...
            <th>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php $form = ActiveForm::begin(['action' => Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),
                        ...
                        <?php $form = ActiveForm::begin(['action' => Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $modelAttribute . '-link-lainnya-form']) ?>
                        ...
                        <?php $form = ActiveForm::begin(['action' => Url::to(['led/isi-non-kriteria','led'=>$model->id,'prodi'=>$prodi->id,'poin'=>$poin]),'options' => ['enctype' => 'multipart/form-data'], 'id' => $modelAttribute . '-lainnya-form']) ?>
