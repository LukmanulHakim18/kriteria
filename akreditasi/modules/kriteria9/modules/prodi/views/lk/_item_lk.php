    ...
    <table class="table">
        ...
        <tr>
            ...
            <th>
                ...
                <?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data'],'action' => Url::to(['lk/isi-kriteria','kriteria'=>$kriteria,'prodi'=>$prodi->id,'lk'=>$lkProdi->id])]) ?>

                <?= $form->field($dokUploadModel, 'jenisDokumen')->textInput(['value' => Constants::LAINNYA, 'readonly' => true]) ?>
                <?= $form->field($dokUploadModel, 'kodeDokumen')->textInput(['value' => $item->tabel, 'readonly' => true]) ?>
                ...
                <?= $form->field($dokTextModel, 'jenisDokumen')->textInput(['value' => Constants::LAINNYA, 'readonly' => true]) ?>
                ...
                <?= $form->field($dokLinkModel, 'jenisDokumen')->textInput(['value' => Constants::LAINNYA, 'readonly' => true]) ?>
        ...
        <tbody>
        <?php
        $details = $lkCollection->where('jenis_dokumen',Constants::LAINNYA)->where('kode_dokumen',$item->tabel)->values()->all();
