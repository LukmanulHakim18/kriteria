    ...
    if (!empty($doksum->kode)) : ?>
        ...
        <tr>
            ...
            <td class="pull-right">
                ...
                <?= $form->field($dokUploadModel, 'jenisDokumen')->textInput(['value' => $jenis, 'readonly' => true]) ?>
                <?= $form->field($dokUploadModel, 'kodeDokumen')->textInput(['value' => $doksum->kode, 'readonly' => true]) ?>
                ...
                <?= $form->field($dokTextModel, 'jenisDokumen')->textInput(['value' => $jenis, 'readonly' => true]) ?>
                ...
                <?= $form->field($dokLinkModel, 'jenisDokumen')->textInput(['value' => $jenis, 'readonly' => true]) ?>
