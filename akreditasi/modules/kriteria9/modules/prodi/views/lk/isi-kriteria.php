...
$this->params['breadcrumbs'][] = ['label' => 'Isi Kriteria', 'url' => ['/kriteria9/k9-prodi/lk/isi','lk'=>$lkInstitusi->id, 'prodi'=>$_GET['prodi']]];
        ...
        <div class="kt-section kt-section--first" style="margin-bottom: 0;">
            ...
            <div class="accordion accordion-solid  accordion-toggle-arrow" id="accordionExample2">
                ...
                <?php foreach ($butir as $key => $value) {
                    ...
                    $fileTemplate = $template->where(['nomor_tabel'=>$value['tabel'], 'untuk'=>Constants::PRODI])->one();
                        ...
                        <div id="collapse<?= $key ?>" class="collapse" aria-labelledby="heading<?= $key ?>" data-parent="#accordionExample2" style="">
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>
                                            <strong><?= $fileTemplate['nama_file'];?></strong>
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" >
                                            ...
                                            if (empty($modelTemp)) { /*Jika Dokumen tidak ada di database*/ ?>
                                                ...
                                                <?php Modal::begin([
                                                    'title' => 'Upload Dokumen Template Laporan Kinerja',
                                                    ...
                                                    if ($item['kode_dokumen'] != $value['tabel']) { /*Jika Kode Dokumen tidak ada di database*/ ?>
                                                        ...
                                                        echo Html::a('<i class="la la-trash"></i> &nbsp;Hapus', ['lk/hapus-dok'], ['class' => 'btn btn-danger btn-pill btn-elevate btn-elevate-air pull-right',
                                                            'data' => [
                                                                ...
                                                                'params' => ['id' => $item['id'], 'kriteria' => $standar, 'lk' => $_GET['lk'], 'prodi'=>$_GET['prodi']]
                                                            ]]);
                                                    }
                                                }
                                            }
                                        ...
                                        <?php  foreach ($model as $key => $item) { if($sumber['kode'] == $item['kode_dokumen'])  {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <?php if ($item->bentuk_dokumen != 'text' && $item->bentuk_dokumen != 'link')  { echo Html::a('<i class="la la-download"></i> &nbsp;Unduh',['lk/download-dok','id'=>$item['id']],['class'=>'btn btn-warning btn-pill btn-elevate btn-elevate-air']);}?>
                                            ...
                                            if ($pendukung['kode'] == $item['kode_dokumen']) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        ...
                                                        <?php if ($item->bentuk_dokumen != 'text' && $item->bentuk_dokumen != 'link')  { echo Html::a('<i class="la la-download"></i> &nbsp;Unduh', ['lk/download-dok',  'id' => $item->id], ['class' => 'btn btn-pill btn-elevate btn-elevate-air btn-warning']);} ?>
