...
$this->title = "Lihat Laporan Kinerja";
                ...
                <?php foreach ($json as $kriteriaJson): ?>
                    <tr>
                        ...
                        <td style="padding-top: 15px;">
                            <?= Html::a("<i class='la la-folder-open'></i>Lihat", ['lk/lihat-kriteria', 'lk' => $_GET['lk'], 'kriteria' => $kriteriaJson['kriteria'], 'prodi' => $prodi], ['class' => 'btn btn-default btn-pill btn-elevate btn-elevate-air']) ?>
