 ...
 * @var $poinKriteria [];
 * @var $detail ;
 * @var $detailModel K9DetailLedInstitusiUploadForm ;
 * @var $textModel K9DetailLedInstitusiTeksForm ;
 * @var $linkModel K9DetailLedInstitusiLinkForm ;
 */
$this->title = "Kriteria " . $_GET['kriteria'];
$this->params['breadcrumbs'][] = ['label' => 'Beranda', 'url' => ['/site/index']];
$this->params['breadcrumbs'][] = ['label' => '9 Kriteria', 'url' => ['/kriteria9/default/index']];
$this->params['breadcrumbs'][] = ['label' => 'Institusi', 'url' => ['/kriteria9/k9-institusi/index']];
$this->params['breadcrumbs'][] = ['label' => 'Pencarian Data Institusi', 'url' => ['/kriteria9/k9-institusi/arsip', 'target' => 'isi']];
$this->params['breadcrumbs'][] = ['label' => 'Isi Led', 'url' => ['/kriteria9/k9-institusi/led/isi', 'led' => $_GET['led']]];
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            $detail = call_user_func($detailClass."::find")->where(['id_led_institusi_kriteria'.$kriteria=>$model->id]);
...
';
                                                                ...
                                                                <?= Html::a('<i class ="la la-trash"></i>&nbsp; Hapus', ['led/hapus-detail'], [
                                                                    ...
                                                                    'data' => [
                                                                        ...
                                                                        'params' => ['dokumen' => $v->id, 'kriteria' => $kriteria, 'led' => $_GET['led'],'jenis'=>Constants::SUMBER]
                                                                    ]
                                                                ]) ?>
                                                            </div>
...
';
                                                            ...
                                                            <?= Html::a('<i class ="la la-trash"></i>&nbsp; Hapus', ['led/hapus-detail'], [
                                                                ...
                                                                'data' => [
                                                                    'method' => 'POST',
                                                                    'confirm' => 'Apakah anda yakin menghapus item ini?',
                                                                    'params' => ['dokumen' => $v->id, 'kriteria' => $kriteria, 'led' => $_GET['led'],'jenis'=>Constants::PENDUKUNG]
                                                                ]
                                                            ]) ?>
                                                        </div>
...
';
                                                        ...
                                                        <?= Html::a('<i class ="la la-trash"></i>&nbsp; Hapus', ['led/hapus-detail'], [
                                                            ...
                                                            'data' => [
                                                                'method' => 'POST',
                                                                'confirm' => 'Apakah anda yakin menghapus item ini?',
                                                                'params' => ['dokumen' => $v->id, 'kriteria' => $kriteria, 'led' => $_GET['led'],'jenis'=>Constants::LAINNYA]
                                                            ]
                                                        ]) ?>
                                                    </div>
