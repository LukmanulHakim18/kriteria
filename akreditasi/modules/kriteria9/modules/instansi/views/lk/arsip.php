 ...
 * @var $model K9PencarianLkInstitusiForm
 * @var $dataAkreditasiInstitusi array
 */
$this->title = "Pencarian LK";
    ...
    <div class="kt-portlet__head">
        <div class="kt-portlet__head-label">
            <h3 class="kt-portlet__head-title">
                Form Pencarian Laporan Kinerja
            </h3>
        </div>
    </div>
