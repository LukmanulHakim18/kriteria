 ...
 * @var $kriteria
 * @var $linkModel akreditasi\models\kriteria9\forms\led\K9DetailLedInstitusiLinkForm
 * @var $textModel akreditasi\models\kriteria9\forms\led\K9DetailLedInstitusiTeksForm
 * @var $detailModel \akreditasi\models\kriteria9\forms\led\K9DetailLedInstitusiUploadForm
 * @var $path string
 * @var $model
    ...
    if (!empty($json_dokumen)):
        foreach ($json_dokumen as $keyDok => $dok):
            ...
            foreach ($detail as $k => $v):
                ?>
                <?= $this->render('@akreditasi/modules/kriteria9/modules/institusi/views/led/_item_dokumen_detail', [
                'path' => $path,
                'kriteria' => $kriteria,
                'jenis' => $jenis,
                'detail' => $v,
