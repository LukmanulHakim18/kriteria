...
<div class="kt-portlet">
    ...
    <div class="kt-portlet__body">
        <div class="kt-section kt-section--first" style="margin-bottom: 0;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p class="text-center">Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah Visi dari universitas ini adalah v Visi dari universitas ini adalahVisi dari universitas ini adalahVisi Visi dari universitas ini adalahVisi dari universitas ini adalah v Visi dari universitas ini adalah <?= $modelProfil->visi ?></p>
                </div>
            </div>
