...
$menuItems = [
    [
        'label' => 'Dashboard', 'icon' => "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width=\"24px\" height=\"24px\" viewBox=\"0 0 24 24\" version=\"1.1\" class=\"kt-svg-icon\">
											...
											</svg>", 'url' => ['/unit/default/index','unit'=>$_GET['unit']]
    ],
    ['label' => 'Kegiatan', 'url' => ['/site/index'], 'options' => ['class' => 'kt-menu__section']],
    ['label' => 'Kegiatan Unit/Lembaga/Satker', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
</svg>', 'url' => ['/unit/kegiatan/index','unit'=>$_GET['unit']]],
    ['label' => 'Berkas Unit/Lembaga/Satker', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <rect id="bound" x="0" y="0" width="24" height="24"/>
...
</svg>', 'url' => ['/unit/berkas/index','unit'=>$_GET['unit']]],
