...
class K9LedProdiNarasiKriteria3Form extends K9LedProdiNarasiKriteria3
{
    ...
    {
        $this->ledProdiKriteria3->updateProgress();
        $this->ledProdiKriteria3->ledProdi->updateProgress();
        $this->ledProdiKriteria3->ledProdi->akreditasiProdi->updateProgress()->save(false);
