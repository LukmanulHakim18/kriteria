...
class K9LedProdiNarasiKriteria6Form extends K9LedProdiNarasiKriteria6
{
    ...
    {
        $this->ledProdiKriteria6->updateProgress();
        $this->ledProdiKriteria6->ledProdi->updateProgress();
        $this->ledProdiKriteria6->ledProdi->akreditasiProdi->updateProgress()->save(false);
