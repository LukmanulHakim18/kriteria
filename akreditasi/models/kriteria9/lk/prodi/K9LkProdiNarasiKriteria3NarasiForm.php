...
class K9LkProdiNarasiKriteria3NarasiForm extends K9LkProdiKriteria3Narasi
{
    ...
    {
        $json = K9ProdiJsonHelper::getJsonKriteriaLk(3,$this->lkProdi->akreditasiProdi->prodi->jenjang);
        $count = 0;
