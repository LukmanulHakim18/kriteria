...
class K9LkProdiNarasiKriteria6NarasiForm extends K9LkProdiKriteria6Narasi
{
    ...
    {
        $json = K9ProdiJsonHelper::getJsonKriteriaLk(6,$this->lkProdi->akreditasiProdi->prodi->jenjang);
        $count = 0;
