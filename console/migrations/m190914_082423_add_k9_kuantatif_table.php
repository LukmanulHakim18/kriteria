...
class m190914_082423_add_k9_kuantatif_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%k9_data_kuantitatif_institusi}}',[
            'id' => $this->primaryKey(),
        ...
        $this->addForeignKey('fk-k9_data_kuantitatif_institusi-k9_akreditasi_institusi','{{%k9_data_kuantitatif_institusi}}','id_akreditasi_institusi','{{%k9_akreditasi_institusi}}','id','CASCADE','CASCADE');
        $this->addForeignKey('fk-k9_data_kuantitatif_institusi-usr_crt', '{{%k9_data_kuantitatif_institusi}}','created_by','{{%user}}', 'id','CASCADE','CASCADE');
        $this->addForeignKey('fk-k9_data_kuantitatif_institusi-usr_upd', '{{%k9_data_kuantitatif_institusi}}','updated_by','{{%user}}', 'id','CASCADE','CASCADE');
    }
    ...
    {
        $this->dropForeignKey('fk-k9_data_kuantitatif_institusi-usr_upd','{{%k9_data_kuantitatif_institusi}}');
        $this->dropForeignKey('fk-k9_data_kuantitatif_institusi-usr_crt','{{%k9_data_kuantitatif_institusi}}');
        $this->dropForeignKey('fk-k9_data_kuantitatif_institusi-k9_akreditasi_institusi','{{%k9_data_kuantitatif_institusi}}');
        $this->dropTable('{{%k9_data_kuantitatif_institusi}}');
