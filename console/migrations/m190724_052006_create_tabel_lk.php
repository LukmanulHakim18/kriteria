...
class m190724_052006_create_tabel_lk extends Migration
{
    ...
    private function createTabelProdi()
    {
        ...
        $this->createTable('k9_lk_prodi_kriteria3', [
            ...
            '_3_b_5_1' => $this->longText(),
            '_3_b_5_2' => $this->longText(),
            '_3_b_5_3' => $this->longText(),
            '_3_b_5_4' => $this->longText(),
        ...
        $this->createTable('k9_lk_prodi_kriteria8', [
            ...
            '_8_f_4_1' => $this->longText(),
            '_8_f_4_2' => $this->longText(),
            '_8_f_4_3' => $this->longText(),
            '_8_f_4_4' => $this->longText(),
            'progress' => $this->float()->defaultValue(0),
            'created_at' => $this->integer(),
            'updated_at' => $this->integer()
        ], $tableOptions);
    ...
    private function createTabelInstitusi()
    {
        ...
        $this->createTable('k9_lk_institusi_kriteria3', [
            ...
            '_3_a_4' => $this->longText(),
            '_3_b' => $this->longText(),
            '_3_c_1' => $this->longText(),
            '_3_c_2' => $this->longText(),
            '_3_d' => $this->longText(),
            'progress' => $this->float()->defaultValue(0),
            'created_at' => $this->integer(),
            'updated_at' => $this->integer()
        ...
        $this->createTable('k9_lk_institusi_kriteria5', [
            'id' => $this->primaryKey(),
            'id_lk_institusi' => $this->integer(),
            '_5_a_1' => $this->longText(),
            '_5_a_2' => $this->longText(),
            '_5_b_1' => $this->longText(),
            '_5_b_2' => $this->longText(),
            '_5_c_1' => $this->longText(),
            '_5_c_2_a' => $this->longText(),
            '_5_c_2_b' => $this->longText(),
            '_5_c_2_c_1' => $this->longText(),
            '_5_c_2_c_2' => $this->longText(),
            '_5_c_2_d' => $this->longText(),
            '_5_c_2_e' => $this->longText(),
            '_5_c_2_f' => $this->longText(),
            '_5_c_2_g' => $this->longText(),
            '_5_d_1' => $this->longText(),
            '_5_d_2' => $this->longText(),
            '_5_e_1' => $this->longText(),
            '_5_e_2' => $this->longText(),
            '_5_f' => $this->longText(),
            '_5_g_1' => $this->longText(),
            '_5_g_2' => $this->longText(),
            '_5_h' => $this->longText(),
            'progress' => $this->float()->defaultValue(0),
            'created_at' => $this->integer(),
            'updated_at' => $this->integer()
