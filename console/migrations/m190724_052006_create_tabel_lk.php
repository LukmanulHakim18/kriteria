...
class m190724_052006_create_tabel_lk extends Migration
{
    ...
    private function createTabelProdi()
    {
        ...
        $this->createTable('k9_lk_prodi_kriteria9',[
            'id'=>$this->primaryKey(),
            'id_lk_prodi'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_prodi_kriteria9_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_prodi_kriteria9'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'jenis_dokumen'=>$this->string(),
    ...
    private function createTabelFakultas()
    {
        ...
        //LED FAKULTAS
        $this->createTable('{{%k9_lk_fakultas}}',[
            'id'=>$this->primaryKey(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria1',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
            'updated_at'=>$this->integer()
        ],$tableOptions);

        $this->createTable('k9_lk_fakultas_kriteria2',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria3',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria4',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria5',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria6',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria7',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria8',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria9',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria1_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria1'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria2_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria2'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria3_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria3'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria4_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria4'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria5_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria5'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria6_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria6'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria7_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria7'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria8_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria8'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_fakultas_kriteria9_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_fakultas_kriteria9'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
    ...
    private function dropTabelFakultas()
    {
        ...
        $this->dropTable('k9_lk_fakultas_kriteria_9_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_8_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_7_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_6_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_5_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_4_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_3_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_2_detail');
        $this->dropTable('k9_lk_fakultas_kriteria_1_detail');


        $this->dropTable('k9_lk_fakultas_kriteria_9');
        $this->dropTable('k9_lk_fakultas_kriteria_8');
        $this->dropTable('k9_lk_fakultas_kriteria_7');
        $this->dropTable('k9_lk_fakultas_kriteria_6');
        $this->dropTable('k9_lk_fakultas_kriteria_5');
        $this->dropTable('k9_lk_fakultas_kriteria_4');
        $this->dropTable('k9_lk_fakultas_kriteria_3');
        $this->dropTable('k9_lk_fakultas_kriteria_2');
        $this->dropTable('k9_lk_fakultas_kriteria_1');


        $this->dropTable('{{%k9_lk_fakultas}}');
    }

    private function dropForeignFakultas()
    {
        $this->dropForeignKey('fk-k9_lk_fak-k9_akreditasi_fak','{{%k9_akreditasi_fakultas}}');
        $this->dropForeignKey('fk-k9_lk_fak-fakultas_akademi','{{%k9_lk_fakultas}}');


        $this->dropForeignKey('fk-k9_lk_fak_kt1-k9_lk_fak','{{k9_lk_fakultas_kriteria1}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt2-k9_lk_fak','{{k9_lk_fakultas_kriteria2}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt3-k9_lk_fak','{{k9_lk_fakultas_kriteria3}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt4-k9_lk_fak','{{k9_lk_fakultas_kriteria4}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt5-k9_lk_fak','{{k9_lk_fakultas_kriteria5}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt6-k9_lk_fak','{{k9_lk_fakultas_kriteria6}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt7-k9_lk_fak','{{k9_lk_fakultas_kriteria7}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt8-k9_lk_fak','{{k9_lk_fakultas_kriteria8}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt9-k9_lk_fak','{{k9_lk_fakultas_kriteria9}}');

        $this->dropForeignKey('fk-k9_lk_fak_kt1_detail-k9_lk_fak_kt1','{{k9_lk_fakultas_kriteria1_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt2_detail-k9_lk_fak_kt2','{{k9_lk_fakultas_kriteria2_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt3_detail-k9_lk_fak_kt3','{{k9_lk_fakultas_kriteria3_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt4_detail-k9_lk_fak_kt4','{{k9_lk_fakultas_kriteria4_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt5_detail-k9_lk_fak_kt5','{{k9_lk_fakultas_kriteria5_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt6_detail-k9_lk_fak_kt6','{{k9_lk_fakultas_kriteria6_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt7_detail-k9_lk_fak_kt7','{{k9_lk_fakultas_kriteria7_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt8_detail-k9_lk_fak_kt8','{{k9_lk_fakultas_kriteria8_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt9_detail-k9_lk_fak_kt9','{{k9_lk_fakultas_kriteria9_detail}}');


        $this->dropForeignKey('fk-k9_lk_fak_kt1_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria1_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt2_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria2_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt3_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria3_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt4_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria4_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt5_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria5_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt6_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria6_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt7_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria7_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt8_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria8_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt9_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria9_detail}}');

        $this->dropForeignKey('fk-k9_lk_fak_kt1_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria1_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt2_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria2_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt3_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria3_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt4_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria4_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt5_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria5_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt6_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria6_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt7_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria7_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt8_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria8_detail}}');
        $this->dropForeignKey('fk-k9_lk_fak_kt9_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria9_detail}}');
    }
    ...
    private function addForeignProdi()
    {
        ...
        $this->addForeignKey('fk-k9_lk_prodi_kt9-k9_lk_prodi','{{k9_lk_prodi_kriteria9}}','id_lk_prodi','{{%k9_lk_prodi}}','id','cascade','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_prodi_kt9_detail-k9_lk_prodi_kt9','{{k9_lk_prodi_kriteria9_detail}}','id_lk_prodi_kriteria9','{{%k9_lk_prodi_kriteria9}}','id','cascade','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_prodi_kt9_dtl_crd-usr_crd','{{k9_lk_prodi_kriteria9_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_prodi_kt9_dtl_upd-usr_upd','{{k9_lk_prodi_kriteria9_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
    ...
    {
        $this->addForeignKey('fk-k9_lk_fak-k9_akreditasi_fak','{{%k9_lk_fakultas}}','id_akreditasi','{{%k9_akreditasi}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak-fakultas_akademi','{{%k9_lk_fakultas}}','id_fakultas','{{%fakultas_akademi}}','id','cascade','cascade');

        $this->addForeignKey('fk-k9_lk_fak_kt1-k9_lk_fak','{{k9_lk_fakultas_kriteria1}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt2-k9_lk_fak','{{k9_lk_fakultas_kriteria2}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt3-k9_lk_fak','{{k9_lk_fakultas_kriteria3}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt4-k9_lk_fak','{{k9_lk_fakultas_kriteria4}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt5-k9_lk_fak','{{k9_lk_fakultas_kriteria5}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt6-k9_lk_fak','{{k9_lk_fakultas_kriteria6}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt7-k9_lk_fak','{{k9_lk_fakultas_kriteria7}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt8-k9_lk_fak','{{k9_lk_fakultas_kriteria8}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt9-k9_lk_fak','{{k9_lk_fakultas_kriteria9}}','id_lk_fakultas','{{%k9_lk_fakultas}}','id','cascade','cascade');

        $this->addForeignKey('fk-k9_lk_fak_kt1_detail-k9_lk_fak_kt1','{{k9_lk_fakultas_kriteria1_detail}}','id_lk_fakultas_kriteria1','{{%k9_lk_fakultas_kriteria1}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt2_detail-k9_lk_fak_kt2','{{k9_lk_fakultas_kriteria2_detail}}','id_lk_fakultas_kriteria2','{{%k9_lk_fakultas_kriteria2}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt3_detail-k9_lk_fak_kt3','{{k9_lk_fakultas_kriteria3_detail}}','id_lk_fakultas_kriteria3','{{%k9_lk_fakultas_kriteria3}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt4_detail-k9_lk_fak_kt4','{{k9_lk_fakultas_kriteria4_detail}}','id_lk_fakultas_kriteria4','{{%k9_lk_fakultas_kriteria4}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt5_detail-k9_lk_fak_kt5','{{k9_lk_fakultas_kriteria5_detail}}','id_lk_fakultas_kriteria5','{{%k9_lk_fakultas_kriteria5}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt6_detail-k9_lk_fak_kt6','{{k9_lk_fakultas_kriteria6_detail}}','id_lk_fakultas_kriteria6','{{%k9_lk_fakultas_kriteria6}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt7_detail-k9_lk_fak_kt7','{{k9_lk_fakultas_kriteria7_detail}}','id_lk_fakultas_kriteria7','{{%k9_lk_fakultas_kriteria7}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt8_detail-k9_lk_fak_kt8','{{k9_lk_fakultas_kriteria8_detail}}','id_lk_fakultas_kriteria8','{{%k9_lk_fakultas_kriteria8}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt9_detail-k9_lk_fak_kt9','{{k9_lk_fakultas_kriteria9_detail}}','id_lk_fakultas_kriteria9','{{%k9_lk_fakultas_kriteria9}}','id','cascade','cascade');


        $this->addForeignKey('fk-k9_lk_fak_kt1_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria1_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt2_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria2_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt3_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria3_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt4_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria4_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt5_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria5_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt6_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria6_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt7_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria7_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt8_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria8_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt9_dtl_crd-usr_crd','{{k9_lk_fakultas_kriteria9_detail}}','created_by','{{%user}}','id','CASCADE','cascade');

        $this->addForeignKey('fk-k9_lk_fak_kt1_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria1_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt2_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria2_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt3_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria3_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt4_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria4_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt5_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria5_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt6_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria6_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt7_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria7_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt8_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria8_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_fak_kt9_dtl_upd-usr_upd','{{k9_lk_fakultas_kriteria9_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
    ...
    private function createTabelInstitusi()
    {
        ...
        //LED INSTITUSI
        $this->createTable('{{%k9_lk_institusi}}',[
            'id'=>$this->primaryKey(),
        ...
        $this->createTable('k9_lk_institusi_kriteria6',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_institusi_kriteria7',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_institusi_kriteria8',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_institusi_kriteria9',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi'=>$this->integer(),
            'progress'=>$this->float()->defaultValue(0),
            'created_at'=>$this->integer(),
        ...
        $this->createTable('k9_lk_institusi_kriteria1_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria1'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria2_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria2'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria3_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria3'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria4_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria4'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria5_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria5'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria6_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria6'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria7_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria7'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria8_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria8'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
        ...
        $this->createTable('k9_lk_institusi_kriteria9_detail',[
            'id'=>$this->primaryKey(),
            'id_lk_institusi_kriteria9'=>$this->integer(),
            'kode_dokumen'=>$this->string(),
            'nama_dokumen'=>$this->string(),
            'isi_dokumen'=>$this->string(),
            'bentuk_dokumen'=>$this->string(),
    ...
    private function dropInstitusi()
    {
        ...
        $this->dropTable('k9_lk_institusi_kriteria_9_detail');
        $this->dropTable('k9_lk_institusi_kriteria_8_detail');
        $this->dropTable('k9_lk_institusi_kriteria_7_detail');
        $this->dropTable('k9_lk_institusi_kriteria_6_detail');
        $this->dropTable('k9_lk_institusi_kriteria_5_detail');
        $this->dropTable('k9_lk_institusi_kriteria_4_detail');
        $this->dropTable('k9_lk_institusi_kriteria_3_detail');
        $this->dropTable('k9_lk_institusi_kriteria_2_detail');
        $this->dropTable('k9_lk_institusi_kriteria_1_detail');


        $this->dropTable('k9_lk_institusi_kriteria_9');
        $this->dropTable('k9_lk_institusi_kriteria_8');
        $this->dropTable('k9_lk_institusi_kriteria_7');
        $this->dropTable('k9_lk_institusi_kriteria_6');
        $this->dropTable('k9_lk_institusi_kriteria_5');
        $this->dropTable('k9_lk_institusi_kriteria_4');
        $this->dropTable('k9_lk_institusi_kriteria_3');
        $this->dropTable('k9_lk_institusi_kriteria_2');
        $this->dropTable('k9_lk_institusi_kriteria_1');


        $this->dropTable('{{%k9_lk_institusi}}');
    }
    ...
    private function addForeignInstitusi()
    {
        ...
        $this->addForeignKey('fk-k9_lk_institusi_kt6-k9_lk_institusi','{{k9_lk_institusi_kriteria6}}','id_lk_institusi','{{%k9_lk_institusi}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt7-k9_lk_institusi','{{k9_lk_institusi_kriteria7}}','id_lk_institusi','{{%k9_lk_institusi}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt8-k9_lk_institusi','{{k9_lk_institusi_kriteria8}}','id_lk_institusi','{{%k9_lk_institusi}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt9-k9_lk_institusi','{{k9_lk_institusi_kriteria9}}','id_lk_institusi','{{%k9_lk_institusi}}','id','cascade','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_institusi_kt6_detail-k9_lk_institusi_kt6','{{k9_lk_institusi_kriteria6_detail}}','id_lk_institusi_kriteria6','{{%k9_lk_institusi_kriteria6}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt7_detail-k9_lk_institusi_kt7','{{k9_lk_institusi_kriteria7_detail}}','id_lk_institusi_kriteria7','{{%k9_lk_institusi_kriteria7}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt8_detail-k9_lk_institusi_kt8','{{k9_lk_institusi_kriteria8_detail}}','id_lk_institusi_kriteria8','{{%k9_lk_institusi_kriteria8}}','id','cascade','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt9_detail-k9_lk_institusi_kt9','{{k9_lk_institusi_kriteria9_detail}}','id_lk_institusi_kriteria9','{{%k9_lk_institusi_kriteria9}}','id','cascade','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_institusi_kt6_dtl_crd-usr_crd','{{k9_lk_institusi_kriteria6_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt7_dtl_crd-usr_crd','{{k9_lk_institusi_kriteria7_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt8_dtl_crd-usr_crd','{{k9_lk_institusi_kriteria8_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt9_dtl_crd-usr_crd','{{k9_lk_institusi_kriteria9_detail}}','created_by','{{%user}}','id','CASCADE','cascade');
        ...
        $this->addForeignKey('fk-k9_lk_institusi_kt6_dtl_upd-usr_upd','{{k9_lk_institusi_kriteria6_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt7_dtl_upd-usr_upd','{{k9_lk_institusi_kriteria7_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt8_dtl_upd-usr_upd','{{k9_lk_institusi_kriteria8_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
        $this->addForeignKey('fk-k9_lk_institusi_kt9_dtl_upd-usr_upd','{{k9_lk_institusi_kriteria9_detail}}','updated_by','{{%user}}','id','CASCADE','cascade');
