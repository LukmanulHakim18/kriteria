...
class m210113_091604_alter_ekspor_dokumen_to_polymorph extends Migration
{
    ...
    public function safeUp()
    {
        ...
        //institusi
        $this->dropForeignKey('fk-k9_dokumen_led_inst-k9_led_inst', '{{%k9_institusi_ekspor_dokumen}}');
        $this->renameColumn('{{%k9_institusi_ekspor_dokumen}}', 'id_led_institusi', 'external_id');
        $this->addColumn('{{%k9_institusi_ekspor_dokumen}}', 'type', $this->string());
    }
    ...
    public function safeDown()
    {
        ...
        //institusi
        $this->renameColumn('{{%k9_institusi_ekspor_dokumen}}', 'external_id', 'id_led_institusi');
        $this->addForeignKey('fk-k9_dokumen_led_inst-k9_led_inst', '{{%k9_institusi_ekspor_dokumen}}',
            'id_led_institusi', '{{%k9_led_institusi}}', 'id', 'cascade', 'cascade');
        $this->dropColumn('{{%k9_institusi_ekspor_dokumen}}', 'type');
    }
