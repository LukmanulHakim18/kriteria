...
class m190723_170054_create_tabel_led extends Migration
{
    ...
    private function addForeignInstitusi()
    {
        ...
        $this->addForeignKey('fk-k9_led_institusi_n_kt1-k9_led_institusi_kt1', '{{k9_led_institusi_narasi_kriteria1}}', 'id_led_institusi_kriteria1', '{{%k9_led_institusi_kriteria1}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt2-k9_led_institusi_kt2', '{{k9_led_institusi_narasi_kriteria2}}', 'id_led_institusi_kriteria2', '{{%k9_led_institusi_kriteria2}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt3-k9_led_institusi_kt3', '{{k9_led_institusi_narasi_kriteria3}}', 'id_led_institusi_kriteria3', '{{%k9_led_institusi_kriteria3}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt4-k9_led_institusi_kt4', '{{k9_led_institusi_narasi_kriteria4}}', 'id_led_institusi_kriteria4', '{{%k9_led_institusi_kriteria4}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt5-k9_led_institusi_kt5', '{{k9_led_institusi_narasi_kriteria5}}', 'id_led_institusi_kriteria5', '{{%k9_led_institusi_kriteria5}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt6-k9_led_institusi_kt6', '{{k9_led_institusi_narasi_kriteria6}}', 'id_led_institusi_kriteria6', '{{%k9_led_institusi_kriteria6}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt7-k9_led_institusi_kt7', '{{k9_led_institusi_narasi_kriteria7}}', 'id_led_institusi_kriteria7', '{{%k9_led_institusi_kriteria7}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt8-k9_led_institusi_kt8', '{{k9_led_institusi_narasi_kriteria8}}', 'id_led_institusi_kriteria8', '{{%k9_led_institusi_kriteria8}}', 'id', 'cascade', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_n_kt9-k9_led_institusi_kt9', '{{k9_led_institusi_narasi_kriteria9}}', 'id_led_institusi_kriteria9', '{{%k9_led_institusi_kriteria9}}', 'id', 'cascade', 'cascade');
        ...
        $this->addForeignKey('fk-k9_led_institusi_kt1_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria1}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt2_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria2}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt3_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria3}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt4_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria4}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt5_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria5}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt6_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria6}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt7_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria7}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt8_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria8}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt9_n_crd-usr_crd', '{{k9_led_institusi_narasi_kriteria9}}', 'created_by', '{{%user}}', 'id', 'CASCADE', 'cascade');

        $this->addForeignKey('fk-k9_led_institusi_kt1_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria1}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt2_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria2}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt3_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria3}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt4_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria4}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt5_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria5}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt6_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria6}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt7_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria7}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt8_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria8}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
        $this->addForeignKey('fk-k9_led_institusi_kt9_n_upd-usr_upd', '{{k9_led_institusi_narasi_kriteria9}}', 'updated_by', '{{%user}}', 'id', 'CASCADE', 'cascade');
