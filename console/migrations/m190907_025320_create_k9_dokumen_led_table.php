...
class m190907_025320_create_k9_dokumen_led_table extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{%k9_dokumen_led_institusi}}', [
            'id' => $this->primaryKey(),
        ...
        $this->addForeignKey('fk-k9_dokumen_led_inst-k9_led_inst', '{{%k9_dokumen_led_institusi}}', 'id_led_institusi', '{{%k9_led_institusi}}', 'id', 'cascade', 'cascade');
    ...
    {
        $this->dropTable('{{%k9_dokumen_led_institusi}}');
