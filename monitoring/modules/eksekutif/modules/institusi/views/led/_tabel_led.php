...
<div class="kt-portlet">
    ...
    <div class="kt-portlet__body">
        <div class="kt-section kt-section--first" style="margin-bottom: 0;">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?=$this->render('_tabel_led_eksternal',compact('json_eksternal','modelEksternal','untuk','prodi','led','fakultas'))?>

                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?= $this->render('_tabel_led_profil',compact('json_profil','modelProfil','untuk','prodi','led','fakultas')) ?>

                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?=$this->render('_tabel_led_kriteria', compact('json', 'kriteria', 'prodi', 'untuk','led','fakultas'))?>

                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <?=$this->render('_tabel_led_analisis',compact('json_analisis','modelAnalisis','untuk','prodi','led','fakultas'))?>
