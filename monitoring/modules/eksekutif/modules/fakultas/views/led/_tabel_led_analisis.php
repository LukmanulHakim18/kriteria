...
<table class="table">
    ...
    <tr>
        ...
        <td style="padding-top: 15px;">
            <?= Html::a("<i class='la la-folder-open'></i>Lihat", ['led/'.$untuk.'-non-kriteria', 'led' =>$led->id, 'prodi'=>$prodi->id,'poin'=>$json_analisis->nomor,'fakultas'=>$fakultas->id], ['class' => 'btn btn-default btn-pill btn-elevate btn-elevate-air']) ?>
