                        ...
                        <?php foreach ($jsonLk as /* @var Lk*/$kriteriaJson): ?>
                            <tr>
                                ...
                                <td style="padding-top: 15px;">
                                    <?= Html::a("<i class='la la-folder-open'></i>Lihat", ['lk/lihat-kriteria', 'lk' => $_GET['id'], 'kriteria' => $kriteriaJson->kriteria, 'prodi' => $modelProdi->id], ['class' => 'btn btn-default btn-pill btn-elevate btn-elevate-air']) ?>
