...
$menuItems = [
    [
        'label' => 'Dashboard', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg>', 'url' => ['default/index','prodi'=>$_GET['prodi']]
    ],
    ['label' => 'Akreditasi', 'url' => ['/site/index'], 'options' => ['class' => 'kt-menu__section']],
    ['label' => 'Akreditasi Prodi', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
</svg>', 'url' => ['/eksekutif/eksekutif-prodi/akreditasi/index','prodi'=>$_GET['prodi']],
...
JS;
$this->registerJs($counterUp, View::POS_READY);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
