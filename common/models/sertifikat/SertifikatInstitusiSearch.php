...
/**
 * SertifikatInstitusiSearch represents the model behind the search form of `common\models\sertifikat\SertifikatInstitusi`.
 */
class SertifikatInstitusiSearch extends SertifikatInstitusi
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'tgl_akreditasi', 'tgl_kadaluarsa', 'nilai_angka', 'tanggal_pengajuan', 'tanggal_diterima', 'is_publik', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['nama_institusi', 'nama_lembaga', 'nomor_sk', 'nomor_sertifikat', 'nilai_huruf', 'tahun_sk', 'dokumen_sk', 'sertifikat'], 'safe'],
        ];
    }
    ...
    {
        $query = SertifikatInstitusi::find();
        ...
        $query->andFilterWhere(['like', 'nama_institusi', $this->nama_institusi])
