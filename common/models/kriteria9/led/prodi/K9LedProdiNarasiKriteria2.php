 ...
 *
 * @property K9LedProdi $ledProdiKriteria2
 */
class K9LedProdiNarasiKriteria2 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_led_prodi_kriteria2', 'created_at', 'updated_at'], 'integer'],
            [['_2_1', '_2_2', '_2_3', '_2_4', '_2_5', '_2_6', '_2_7', '_2_8', '_2_9'], 'string'],
            [['progress'], 'number'],
            [['id_led_prodi_kriteria2'], 'exist', 'skipOnError' => true, 'targetClass' => K9LedProdi::className(), 'targetAttribute' => ['id_led_prodi_kriteria2' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(K9LedProdi::className(), ['id' => 'id_led_prodi_kriteria2']);
    }
}
