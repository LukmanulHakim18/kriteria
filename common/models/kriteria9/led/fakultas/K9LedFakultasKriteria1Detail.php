...
class K9LedFakultasKriteria1Detail extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_led_fakultas_kriteria1', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['kode_dokumen', 'nama_dokumen', 'jenis_dokumen'], 'string', 'max' => 255],
            [['id_led_fakultas_kriteria1'], 'exist', 'skipOnError' => true, 'targetClass' => K9LedFakultasKriteria1::className(), 'targetAttribute' => ['id_led_fakultas_kriteria1' => 'id']],
    ...
    {
        return $this->hasOne(K9LedFakultasKriteria1::className(), ['id' => 'id_led_fakultas_kriteria1']);
    }
