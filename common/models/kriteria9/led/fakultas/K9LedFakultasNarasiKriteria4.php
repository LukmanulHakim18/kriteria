 ...
 *
 * @property K9LedFakultas $ledFakultasKriteria4
 */
class K9LedFakultasNarasiKriteria4 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_led_fakultas_kriteria4', 'created_at', 'updated_at'], 'integer'],
            [['_4_1', '_4_2', '_4_3', '_4_4', '_4_5', '_4_6', '_4_7', '_4_8', '_4_9'], 'string'],
            [['progress'], 'number'],
            [['id_led_fakultas_kriteria4'], 'exist', 'skipOnError' => true, 'targetClass' => K9LedFakultas::className(), 'targetAttribute' => ['id_led_fakultas_kriteria4' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(K9LedFakultas::className(), ['id' => 'id_led_fakultas_kriteria4']);
    }
}
