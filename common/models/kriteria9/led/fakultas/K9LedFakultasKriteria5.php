 ...
 * @property K9LedFakultasNarasiKriteria5[] $k9LedFakultasNarasiKriteria5s
 */
class K9LedFakultasKriteria5 extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LedFakultasNarasiKriteria5s()
    {
        return $this->hasMany(K9LedFakultasNarasiKriteria5::className(), ['id_led_fakultas_kriteria5' => 'id']);
    }
}
