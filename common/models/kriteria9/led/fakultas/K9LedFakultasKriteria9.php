 ...
 * @property K9LedFakultasNarasiKriteria9[] $k9LedFakultasNarasiKriteria9s
 */
class K9LedFakultasKriteria9 extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LedFakultasNarasiKriteria9s()
    {
        return $this->hasMany(K9LedFakultasNarasiKriteria9::className(), ['id_led_fakultas_kriteria9' => 'id']);
    }
}
