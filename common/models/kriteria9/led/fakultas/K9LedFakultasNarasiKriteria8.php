 ...
 *
 * @property K9LedFakultas $ledFakultasKriteria8
 */
class K9LedFakultasNarasiKriteria8 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_led_fakultas_kriteria8', 'created_at', 'updated_at'], 'integer'],
            [['_8_1', '_8_2', '_8_3', '_8_4', '_8_5', '_8_6', '_8_7', '_8_8', '_8_9'], 'string'],
            [['progress'], 'number'],
            [['id_led_fakultas_kriteria8'], 'exist', 'skipOnError' => true, 'targetClass' => K9LedFakultas::className(), 'targetAttribute' => ['id_led_fakultas_kriteria8' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(K9LedFakultas::className(), ['id' => 'id_led_fakultas_kriteria8']);
    }
}
