...
class K9LedInstitusiNarasiKriteria9 extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['_9_4_a', '_9_4_b', '_9_9', '_9_7', '_9_5', '_9_6', '_9_8'], 'string'],
            [['progress'], 'number'],
            [
                ['created_by'],
                'exist',
            ...
            [
                ['id_led_institusi_kriteria9'],
                'exist',
                'skipOnError' => true,
                'targetClass' => K9LedInstitusiKriteria9::className(),
                'targetAttribute' => ['id_led_institusi_kriteria9' => 'id']
            ],
        ];
    }
