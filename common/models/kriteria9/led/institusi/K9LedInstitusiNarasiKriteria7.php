 ...
 *
 * @property K9LedInstitusi $ledInstitusiKriteria7
 */
class K9LedInstitusiNarasiKriteria7 extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_led_institusi_kriteria7', 'created_at', 'updated_at'], 'integer'],
            [['_7_1', '_7_2', '_7_3', '_7_4', '_7_5', '_7_6', '_7_7', '_7_8', '_7_9'], 'string'],
            [['progress'], 'number'],
            [['id_led_institusi_kriteria7'], 'exist', 'skipOnError' => true, 'targetClass' => K9LedInstitusi::className(), 'targetAttribute' => ['id_led_institusi_kriteria7' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(K9LedInstitusi::className(), ['id' => 'id_led_institusi_kriteria7']);
    }
}
