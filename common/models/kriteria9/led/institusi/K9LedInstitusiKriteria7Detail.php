...
/**
 * This is the model class for table "k9_led_institusi_kriteria7_detail".
 *
 * @property int $id
 ...
 */
class K9LedInstitusiKriteria7Detail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_led_institusi_kriteria7_detail';
    }
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        $this->ledInstitusiKriteria7->ledInstitusi->akreditasiInstitusi->updateProgress();
