...
class K9LedInstitusiNarasiKriteria3 extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['_3_1', '_3_2', '_3_3', '_3_4_a', '_3_4_b', '_3_5', '_3_6', '_3_7', '_3_8', '_3_9'], 'string'],
            [['progress'], 'number'],
            [
                ['created_by'],
                'exist',
            ...
            [
                ['id_led_institusi_kriteria3'],
                'exist',
                'skipOnError' => true,
                'targetClass' => K9LedInstitusiKriteria3::className(),
                'targetAttribute' => ['id_led_institusi_kriteria3' => 'id']
            ],
        ];
    }
