 ...
 * @property K9LedInstitusiNarasiKriteria8 $k9LedInstitusiNarasiKriteria8s
 */
class K9LedInstitusiKriteria8 extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LedInstitusiNarasiKriteria8s()
    {
        return $this->hasOne(K9LedInstitusiNarasiKriteria8::className(), ['id_led_institusi_kriteria8' => 'id']);
    }

    public function updateProgress()
    {
        $narasi = $this->k9LedInstitusiNarasiKriteria8s->progress;

        $dokumen = K9InstitusiProgressHelper::getDokumenLedProgress($this->id_led_institusi,$this->getK9LedInstitusiKriteria8Details(), 8);
