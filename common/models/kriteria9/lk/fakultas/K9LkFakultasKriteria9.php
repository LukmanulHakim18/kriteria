...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria9".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria9Detail[] $k9LkFakultasKriteria9Details
 */
class K9LkFakultasKriteria9 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria9';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria9Details()
    {
        return $this->hasMany(K9LkFakultasKriteria9Detail::className(), ['id_lk_fakultas_kriteria9' => 'id']);
    }
}
