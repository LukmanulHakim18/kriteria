...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria3".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria3Detail[] $k9LkFakultasKriteria3Details
 */
class K9LkFakultasKriteria3 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria3';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria3Details()
    {
        return $this->hasMany(K9LkFakultasKriteria3Detail::className(), ['id_lk_fakultas_kriteria3' => 'id']);
    }
}
