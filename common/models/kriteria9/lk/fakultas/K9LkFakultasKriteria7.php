...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria7".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria7Detail[] $k9LkFakultasKriteria7Details
 */
class K9LkFakultasKriteria7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria7';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria7Details()
    {
        return $this->hasMany(K9LkFakultasKriteria7Detail::className(), ['id_lk_fakultas_kriteria7' => 'id']);
    }
}
