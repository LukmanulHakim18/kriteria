...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria2".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria2Detail[] $k9LkFakultasKriteria2Details
 */
class K9LkFakultasKriteria2 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria2';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria2Details()
    {
        return $this->hasMany(K9LkFakultasKriteria2Detail::className(), ['id_lk_fakultas_kriteria2' => 'id']);
    }
}
