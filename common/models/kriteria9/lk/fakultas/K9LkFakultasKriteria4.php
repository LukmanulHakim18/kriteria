...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria4".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria4Detail[] $k9LkFakultasKriteria4Details
 */
class K9LkFakultasKriteria4 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria4';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria4Details()
    {
        return $this->hasMany(K9LkFakultasKriteria4Detail::className(), ['id_lk_fakultas_kriteria4' => 'id']);
    }
}
