...
/**
 * This is the model class for table "k9_lk_fakultas_kriteria5".
 *
 * @property int $id
 ...
 * @property K9LkFakultasKriteria5Detail[] $k9LkFakultasKriteria5Details
 */
class K9LkFakultasKriteria5 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_fakultas_kriteria5';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkFakultasKriteria5Details()
    {
        return $this->hasMany(K9LkFakultasKriteria5Detail::className(), ['id_lk_fakultas_kriteria5' => 'id']);
    }
}
