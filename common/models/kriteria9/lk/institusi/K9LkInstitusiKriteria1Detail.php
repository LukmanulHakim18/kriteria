...
/**
 * This is the model class for table "k9_lk_institusi_kriteria1_detail".
 *
 * @property int $id
 ...
 */
class K9LkInstitusiKriteria1Detail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_institusi_kriteria1_detail';
    }
    ...
    {
        return [
            [['id_lk_institusi_kriteria1', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_lk_institusi_kriteria1' => 'Id Lk Institusi Kriteria1',
