...
/**
 * This is the model class for table "k9_lk_institusi_kriteria7".
 *
 * @property int $id
 ...
 * @property K9LkInstitusiKriteria7Detail[] $k9LkInstitusiKriteria7Details
 */
class K9LkInstitusiKriteria7 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_institusi_kriteria7';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkInstitusiKriteria7Details()
    {
        return $this->hasMany(K9LkInstitusiKriteria7Detail::className(), ['id_lk_institusi_kriteria7' => 'id']);
    }

    public function updateProgress()
    {

        $dokumen = K9InstitusiProgressHelper::getDokumenLkProgress($this->id_lk_institusi,$this->getK9LkInstitusiKriteria7Details(), 7);
