...
/**
 * This is the model class for table "k9_lk_institusi_kriteria2_detail".
 *
 * @property int $id
 ...
 */
class K9LkInstitusiKriteria2Detail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_institusi_kriteria2_detail';
    }
    ...
    {
        return [
            [['id_lk_institusi_kriteria2', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['kode_dokumen', 'nama_dokumen', 'isi_dokumen', 'bentuk_dokumen', 'jenis_dokumen'], 'string', 'max' => 255],
            [['id_lk_institusi_kriteria2'], 'exist', 'skipOnError' => true, 'targetClass' => K9LkInstitusiKriteria2::className(), 'targetAttribute' => ['id_lk_institusi_kriteria2' => 'id']],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_lk_institusi_kriteria2' => 'Id Lk Institusi Kriteria2',
    ...
    {
        $this->lkInstitusiKriteria2->updateProgressDokumen()->save(false);
