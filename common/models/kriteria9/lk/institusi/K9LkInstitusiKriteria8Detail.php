...
class K9LkInstitusiKriteria8Detail extends \yii\db\ActiveRecord
{
    ...
    {
        $this->lkInstitusiKriteria8->updateProgress();
        $this->lkInstitusiKriteria8->lkInstitusi->updateProgress();
        $this->lkInstitusiKriteria8->lkInstitusi->akreditasiInstitusi->updateProgress();
