...
/**
 * This is the model class for table "k9_lk_institusi_kriteria8".
 *
 * @property int $id
 ...
 * @property K9LkInstitusiKriteria8Detail[] $k9LkInstitusiKriteria8Details
 */
class K9LkInstitusiKriteria8 extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_institusi_kriteria8';
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getK9LkInstitusiKriteria8Details()
    {
        return $this->hasMany(K9LkInstitusiKriteria8Detail::className(), ['id_lk_institusi_kriteria8' => 'id']);
    }

    public function updateProgress()
    {

        $dokumen = K9InstitusiProgressHelper::getDokumenLkProgress($this->id_lk_institusi,$this->getK9LkInstitusiKriteria8Details(), 8);
