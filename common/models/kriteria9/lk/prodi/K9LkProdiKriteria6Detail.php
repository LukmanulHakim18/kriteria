...
/**
 * This is the model class for table "k9_lk_prodi_kriteria6_detail".
 *
 * @property int $id
 ...
 */
class K9LkProdiKriteria6Detail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_prodi_kriteria6_detail';
    }
    ...
    {
        return [
            [['id_lk_prodi_kriteria6', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_lk_prodi_kriteria6' => 'Id Lk Prodi Kriteria6',
    ...
    {
        $this->lkProdiKriteria6->updateProgress();
        $this->lkProdiKriteria6->lkProdi->updateProgress();
        $this->lkProdiKriteria6->lkProdi->akreditasiProdi->updateProgress();
