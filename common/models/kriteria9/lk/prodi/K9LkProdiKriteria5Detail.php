...
/**
 * This is the model class for table "k9_lk_prodi_kriteria5_detail".
 *
 * @property int $id
 ...
 */
class K9LkProdiKriteria5Detail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'k9_lk_prodi_kriteria5_detail';
    }
    ...
    {
        return [
            [['id_lk_prodi_kriteria5', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'id_lk_prodi_kriteria5' => 'Id Lk Prodi Kriteria5',
