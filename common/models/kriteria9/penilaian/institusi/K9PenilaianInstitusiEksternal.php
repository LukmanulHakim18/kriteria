...
/**
 * This is the model class for table "k9_penilaian_institusi_eksternal".
 *
 * @property int $id
 ...
 */
class K9PenilaianInstitusiEksternal extends \yii\db\ActiveRecord
{
    ...
    {
        return 'k9_penilaian_institusi_eksternal';
    }
    ...
    {
        $json = K9InstitusiJsonHelper::getJsonPenilaianKondisiEksternal();
