...
/**
 * This is the model class for table "k9_penilaian_institusi_analisis".
 *
 * @property int $id
 * @property int|null $id_akreditasi_institusi
 * @property string|null $_1_1
 * @property string|null $_2_1
 * @property string|null $_3_1
 * @property string|null $_4_1
...
class K9PenilaianInstitusiAnalisis extends \yii\db\ActiveRecord
{
    ...
    {
        return 'k9_penilaian_institusi_analisis';
    }
