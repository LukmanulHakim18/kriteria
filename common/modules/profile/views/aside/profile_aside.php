            ...
            <div class="kt-widget kt-widget--user-profile-1">
                ...
                <div class="kt-widget__body">
                    ...
                    <div class="kt-widget__items">
                        <a href="<?=\yii\helpers\Url::to(['default/index'])?>" class="kt-widget__item <?=$controller !== 'default'?: "kt-widget__item--active"?>">
                        ...
                        <a href="<?=\yii\helpers\Url::to(['account/edit-account'])?>" class="kt-widget__item <?=$action !== 'edit-account'?: "kt-widget__item--active"?>">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <a href="<?=\yii\helpers\Url::to(['account/change-password'])?>" class="kt-widget__item <?=$action !== 'change-password'?: "kt-widget__item--active"?>">
															<span class="kt-widget__section">
																<span class="kt-widget__icon">
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
